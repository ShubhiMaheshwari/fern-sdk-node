...
export const FetchSettlementReconDataItem: core.serialization.ObjectSchema<
    serializers.FetchSettlementReconDataItem.Raw,
    ShubhiMaheshwariApi.FetchSettlementReconDataItem
...
export declare namespace FetchSettlementReconDataItem {
    interface Raw {
